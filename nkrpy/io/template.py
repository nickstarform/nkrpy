...
<_templates/{}.py> and should also match a function
within this file for parsing."""

__LOCATION = '_templates'
...
def __default():
    """."""
    return load_cfg(f'{__path__}/{__LOCATION}/default.py')


def __python():
    """."""
    return load_cfg(f'{__path__}/{__LOCATION}/python.py')


def __sh():
    """."""
    return load_cfg(f'{__path__}/{__LOCATION}/sh.py')
