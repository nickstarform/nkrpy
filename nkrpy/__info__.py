...
license = """MPL2.0"""
packages = ['nkrpy', 'nkrpy.misc', 'nkrpy.astro', 'nkrpy.io', 'nkrpy.publication', 'nkrpy.math', 'nkrpy._unit', 'nkrpy.astro.observing', 'nkrpy.astro.image', 'nkrpy.astro.dustmodels', 'nkrpy.astro.spectra', 'nkrpy.astro.reduction', 'nkrpy.astro.mercury', 'nkrpy.astro.spectrum', 'nkrpy.astro.datacube', 'nkrpy.astro._atomiclines', 'nkrpy.astro.keplerian', 'nkrpy.astro.reduction.arcsat', 'nkrpy.astro.reduction.datacube', 'nkrpy.astro.datacube._pvdiagram', 'nkrpy.io._logger', 'nkrpy.io._fits', 'nkrpy.math.gp', 'tests.image', 'tests.misc', 'tests.astro', 'tests.io', 'tests.amlines', 'tests.math', 'tests.unit', 'tests.logger']
scripts = ['./bin/template', './bin/docker_cheatsheet', './bin/outlinegen.py', './bin/latexstrip.py', './bin/docgen.sh', './bin/misc/newPVPlot.py', './bin/misc/submit_jobs.py', './bin/misc/example_reduc.py', './bin/misc/make_line_image.py', './bin/misc/deprojection.py', './bin/misc/QL_ARCSAT.py', './bin/misc/script.py', './bin/misc/matplotlib_colors.py', './bin/misc/jt_mass_c17o.py', './bin/misc/paul_bootstrap.py', './bin/misc/casa_deproj_vis.py', './bin/misc/alma_reduc_misc.py', './bin/misc/arcsat_nightlog_creator.sh', './bin/misc/fft_h370_example.ipynb', './bin/misc/tspec_analysis/template_analysis.ipynb', './bin/misc/tspec_analysis/README.md', './bin/misc/tspec_analysis/.ipynb_checkpoints/template_analysis-checkpoint.ipynb', './bin/templates/template.py', './bin/templates/template.sh', './bin/templates/template.rst', './bin/templates/template.md']
zip_safe = True
include_package_data = True
ext_modules = [<setuptools.extension.Extension('nkrpy.misc.constants') at 0x7fde56c1a890>, <setuptools.extension.Extension('nkrpy.astro.orbit') at 0x7fddc6b08b90>, <setuptools.extension.Extension('nkrpy.math._image') at 0x7fddc578c690>, <setuptools.extension.Extension('nkrpy.math._convert') at 0x7fddc588e050>, <setuptools.extension.Extension('nkrpy.math._fit') at 0x7fddc53082d0>, <setuptools.extension.Extension('nkrpy.math._miscmath') at 0x7fddc4f3d290>, <setuptools.extension.Extension('nkrpy.math._triangle') at 0x7fddc656ead0>, <setuptools.extension.Extension('nkrpy.math._vector') at 0x7fddc6c31550>, <setuptools.extension.Extension('nkrpy.math._sampler') at 0x7fddc6431450>, <setuptools.extension.Extension('nkrpy._unit.unit') at 0x7fddc4f13590>, <setuptools.extension.Extension('nkrpy._unit._base') at 0x7fddc5a22fd0>]
